...
df = pd.read_csv("E:\GUVI $$\project 4 Airbnb analysis\AirbnbDataset.csv")
...
if select == "HOME":
    ...
    with col1:   
        ...
        st.image(Image.open("E:\VS CODE files\.venv\Airbnb_Logo_Bélo.svg.png"),width=500)
    ...
    st.image(Image.open("E:\VS CODE files\.venv\istockphoto-1319184864-612x612.jpg"),width=500)
